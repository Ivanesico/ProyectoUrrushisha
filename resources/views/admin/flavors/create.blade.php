        ...
        <div class="col-lg-8">
            <div class="card shadow border-0 rounded-4">
                <div class="card-body p-4 p-md-5">
                    <h1 class="h3 fw-bold mb-4">Añadir nuevo sabor</h1>

                    <form action="{{ route('admin.flavors.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row g-3">
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="tobacco_type" id="tobacco_type" class="form-control" value="{{ old('tobacco_type') }}">
                                @error('tobacco_type')
                                <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="ingredients_text" id="ingredients_text" rows="3" class="form-control">{{ old('ingredients_text') }}</textarea>
                        ...
                        <div class="d-flex gap-2 mt-4">
                            <button type="submit" class="btn btn-dark px-4">Guardar sabor</button>
